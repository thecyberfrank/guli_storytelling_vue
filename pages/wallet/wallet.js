  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        f: common_vendor.sr(investPopupRef, "bd0d5574-1", {
          "k": "investPopupRef"
        }),
        g: common_vendor.p({
          position: "bottom"
        }),
        h: common_vendor.sr("customAmountDialogRef", "bd0d5574-3,bd0d5574-2"),
        ...
        k: common_vendor.sr(customAmountPopupRef, "bd0d5574-2", {
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/914/ListenToBooks-master/ListenToBooks-master/pages/wallet/wallet.vue"]]);
