    ...
    return (_ctx, _cache) => {
      return {
        ...
        b: common_vendor.f(pageInfo.goodsList, (item, index, i0) => {
          return {
            a: item.id,
            b: "5d165266-2-" + i0 + ",5d165266-0",
            c: common_vendor.p({
              data: item
            })
          };
        }),
        c: common_vendor.sr(zPagingRef, "5d165266-0", {
          "k": "zPagingRef"
        }),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/914/ListenToBooks-master/ListenToBooks-master/pages/search/search.vue"]]);
