  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        n: common_vendor.sr(shareRef, "5ec865c2-5", {
          "k": "shareRef"
        }),
        o: common_vendor.p({
          type: "share",
        ...
        r: common_vendor.sr(deletePopUpRef, "5ec865c2-7", {
          "k": "deletePopUpRef"
        }),
        s: common_vendor.p({
          type: "dialog"
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/914/ListenToBooks-master/ListenToBooks-master/components/TrackItemCard/TrackItemCard.vue"]]);
