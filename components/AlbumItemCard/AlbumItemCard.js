  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        o: common_vendor.sr(shareRef, "2a8d050a-5", {
          "k": "shareRef"
        }),
        p: common_vendor.p({
          type: "share",
        ...
        s: common_vendor.sr(deletePopUpRef, "2a8d050a-7", {
          "k": "deletePopUpRef"
        }),
        t: common_vendor.p({
          type: "dialog"
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/914/ListenToBooks-master/ListenToBooks-master/components/AlbumItemCard/AlbumItemCard.vue"]]);
