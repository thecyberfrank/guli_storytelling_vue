...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    k: common_vendor.sr("guiPageRefresh", "6add9692-0"),
    ...
    o: common_vendor.sr("guipageloadmore", "6add9692-1"),
    p: common_vendor.p({
    ...
    E: $data.fixedTop + "px",
    F: common_vendor.sr("guipageloading", "6add9692-3"),
    G: $data.pageStatus ? 1 : 0,
    H: common_vendor.n($props.fullPage || $props.refresh || $props.loadmore ? "gui-flex1" : "")
  });
}
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/914/ListenToBooks-master/ListenToBooks-master/Grace6/components/gui-page.vue"]]);
